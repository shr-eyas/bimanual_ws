...
class TestController:
    def __init__(self):
        ...
        # 2) Assembly poses:
        self.x_assembly_fr3,    self.q_assembly_fr3     = np.array([ 0.428078 ,-0.718574 , 0.420046]), np.array([ 0.486284 , 0.528266, -0.502616  ,0.481497])
        ...
        self.x_final_heal, self.q_final_heal = np.array([-0.43, 0.4484379455390496, 0.41449499125848754]), np.array([-0.10345417287658103, 0.7095098836010515, -0.032842406583131464 ,0.6962861017690021])
